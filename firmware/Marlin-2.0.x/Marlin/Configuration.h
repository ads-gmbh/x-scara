...
/**
 * X-SCARA is developed by Alex Mircescu in 2021 and is an open source 
 * SCARA machine with an unique mechanical design, intented to simplify the
...
#define CUSTOM_MACHINE_NAME "X-SCARA"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 78.35, 418.5 }
